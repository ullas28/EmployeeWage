/*Ability to manage Employee Wage of multiple companies - Note: Refactor to have one EmpWageBuilder to manage for Wage
for multiple Company - Create EmpWageBuilderArray class and let EmpWageBuilder has array of many EmpWageBuilderArray Object*/

package com.bridgelabz.employeewage.MultipleCompanies;
...
public class EmpWageBuilderArray {
    ...
    public static void main(String[] args) {
        ...
        EmpWageBuilderArray employeeWageBuilderArray = new EmpWageBuilderArray();
